...
const coapResourceModel	= require('./uniboSupports/coapClientToResourceModel');
...
app.setIoSocket = function( iosock ){
	...
	coapFridge.setIoSocket(iosock); // tentativo disperato
...
var changeResourceModelCoap = function( cmd ){  
    console.log("coap PUT> "+ cmd);
	coapResourceModel.coapPut(cmd);	//see coapClientToResourceModel
}
